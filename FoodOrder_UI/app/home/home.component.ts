...
import { User ,Menu,Order} from '../_models/index';
import { AlertService,UserService,MenuService } from '../_services/index';
...
export class HomeComponent implements OnInit {
    ...
    private loadAllMenus() {
        this.menuService.getAll().subscribe(menus => { this.menus = this.menuItems= menus[0];  console.log(menus[0]); });
    }
}